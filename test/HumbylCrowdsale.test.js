...
contract('HumbylCrowdsale', function ([owner, wallet, investor]) {
  ...
  beforeEach(async function () {
    ...
    this.crowdsale = await HumbylCrowdsale.new(
      this.openingTime, this.closingTime, RATE, wallet, this.token.address, GOAL, CAP, this.rate, this.finalRate
    );
    await this.token.transfer(this.crowdsale.address, CAP * this.rate);
